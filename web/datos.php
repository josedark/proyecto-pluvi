<?php
 ...
 $stmt=$conn->prepare("SELECT * FROM mediciones INNER JOIN municipios on mediciones.IdMuni=municipios.IdMuni
                           INNER  JOIN departamentos on mediciones.IdDepto=departamentos.IdDepto");
 $stmt->execute();
